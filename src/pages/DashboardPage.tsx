...
const SalesRepDashboard: React.FC = () => {
  return (
    <div className="container mx-auto px-4 py-8 mt-10 ">
          ...
          <ul className="space-y-4">
            <li className="border-b pb-4">
              ...
              <p className="text-gray-600">
                Looking for more details about Product A.
              </p>
            </li>
            <li className="border-b pb-4">
              <p className="text-gray-800 font-medium">Customer 2</p>
              <p className="text-gray-600">
                Interested in bulk purchase discounts for Product C.
              </p>
            </li>
            <li>
        ...
        <div className="bg-white shadow-md rounded-lg p-4">
          <ul className="space-y-4">
            <li className="border-b pb-4">
              ...
              <p className="text-gray-600">
                Enroll in online courses like "Effective Communication for Sales
                Professionals."
              </p>
            </li>
            <li className="border-b pb-4">
      ...
      <div className=" right-0 bottom-20 fixed">
        <Chatbot />
      </div>
    </div>
  );
